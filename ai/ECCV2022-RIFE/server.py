...
def uploader_file():
    if request.method == 'POST':
        ...
        subprocess.Popen(args=["python3", "processing.py", pk])
        # 프레임 보간을 위하여 10장의 이미지를 1초짜리 mp4 파일로 변환
        # arg = 'ffmpeg -r 5 -f image2 -i {}/%d.jpg -s 1920x1080 -c:v libx264 -pix_fmt yuv420p {}/result.mp4 -q:v 0 -q:a 0'.format(pk, pk)
        # os.system(arg)
