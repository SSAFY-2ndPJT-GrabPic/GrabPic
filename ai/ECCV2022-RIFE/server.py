...
def uploader_file():
    if request.method == 'POST':
        ...
        arg = 'ffmpeg -r 10 -f image2 -i {}/%02d.png -s 1920x1080 -c:v libx264 -pix_fmt yuv420p {}/result.mp4 -q:v 0 -q:a 0'.format(username, username)
        os.system(arg)
        
        # arg = 'python3 inference_video.py --exp=2 --video={}/result.mp4 --output={}/video.mp4'.format(username, username)
        ...
        subprocess.Popen(args = ["python3", "watch_and_upload.py", username])
